...
[![Integration level](https://dash.yunohost.org/integration/xnbtd.svg)](https://dash.yunohost.org/appci/app/xnbtd) ![Working status](https://ci-apps.yunohost.org/ci/badges/xnbtd.status.svg) ![Maintenance status](https://ci-apps.yunohost.org/ci/badges/xnbtd.maintain.svg)

[![Install xnbtd with YunoHost](https://install-app.yunohost.org/install-with-yunohost.svg)](https://install-app.yunohost.org/?app=xnbtd)
